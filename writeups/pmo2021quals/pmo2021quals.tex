...
\begin{rem}
It's also possible to construct the recursion directly. Let $a_n$ be the number of subsets of $\{1, 2, \ldots, n\}$ with no consecutive odd integers. Then we can show, with the same technique, that $a_n = 2a_{n-2} + 4a_{n-4}$.
\end{rem}
