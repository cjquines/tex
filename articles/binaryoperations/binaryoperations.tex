...
\item (\href{https://artofproblemsolving.com/community/c6h1863157p12608849}{USA TSTST 2019/1}) Find all operations $\star$ over $\RR_{> 0}$ such that $x \star (y \star z) = (x \star y) \cdot z$ (where $\cdot$ is multiplication), and if $x \ge 1$, then $x \star x \ge 1$.
