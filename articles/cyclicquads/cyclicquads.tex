...
Identify thirteen cyclic quadrilaterals with vertices in $\cbr{A, B, C, D, E, F, I, P, Q}$. % AIEF, BFQID, CEPID, DMPQ, BPQC
...
All problems we'll discuss today can be solved by proving some quadrilateral is cyclic, then concluding.
